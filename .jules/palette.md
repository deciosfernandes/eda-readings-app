...
## 2026-05-28 - [Visual deltas for historical data tracking]
**Learning:** Providing a visual "delta" (difference) between consecutive numerical records (e.g., meter readings) allows users to immediately grasp trends without manual calculation. Using a distinctive badge with an icon (e.g., 'Icons.trending_up') and localized labels (e.g., "+15 kWh") provides both delight and clarity.
**Action:** When displaying sequential data, pre-calculate differences and display them using a dedicated, themed badge component.
