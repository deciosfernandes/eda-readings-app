...
class _DashboardScreenState extends State<_DashboardScreen> {
  ...
  // BOLT: Pre-calculated consumption deltas (difference from previous reading).
  ...
  Future<void> _loadData() async {
    ...
    for (int i = 0; i < historyLength; i++) {
      ...
      // PALETTE: Calculate consumption delta (difference from chronological previous reading).
      // Since _history is sorted newest-first, the previous reading is at index i + 1.
      String? delta;
      ...
      if (delta != null) buffer.write(', $delta kWh');
